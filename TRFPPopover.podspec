...
Pod::Spec.new do |s|
  ...
  s.name         = "TRFPPopover"
  s.version      = "0.0.1"
  s.summary      = "fork fro TRFPPopover"
  ...
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/PodRepo/TRFPPopover.git", :tag => s.version }

  s.source_files  = "Classes/**/*.{h,m}"
  #s.exclude_files = "Classes/Exclude"
  #s.private_header_files = "Classes/TRVoice2Word/IATConfig.h"
#s.public_header_files = "Classes/AES/{TRFPPopover,NSData+Base64,NSString+Base64}.h"
